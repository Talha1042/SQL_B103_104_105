...
INSERT INTO talebeler VALUES ('Osman',95.5);
INSERT INTO talebeler VALUES ('Sumeyye',95.5);
INSERT INTO talebeler VALUES ('Salih',95.5);
...
tedarikci_id char(5),
urun_id	char(5),
FOREIGN KEY (tedarikci_id) REFERENCES tedarikciler3	
);
...
tedarikci_id char(5),
urun_id	char(5),
CONSTRAINT URN_FK FOREIGN KEY (tedarikci_id) REFERENCES tedarikciler3	
);
